...
--vaccines2006.csv
--Organon Teknika seemed to produce many TB vaccines. This query confirmed they only produced TB vaccines in 2006.
...
--vaccines2007.csv
--Sanofi Pasteur had a good year in 2007. This query confirmed they outputted many different kind of vaccines in 2007.
...
--vaccines2008.csv
--With the last year, we are curious to see if Sanofi has produced more vaccines than the year before. There is an increase in approx. 4,000 vaccines.
...
--vaccines2009.csv
--Where are most HIBV vaccines administered? This is a state-mandated vaccines. There are several routes to investiage. 
...
--vaccines2010.csv
--How many vaccines did Sanofi Pasteur produce in 2009? // ~13,000, approximately the same as 2007.
...
--vaccines2011.csv
-- how many vaccines by Sanofi have a vaccination route of UN? 216
...
--vaccines2012.csv
--How many total vaccines in 2012 had a UN vax_route? 662 that were meant for TDAP. This is for all companies
...
--vaccines2013.csv
--Merck is a successful company in 2013. How many vaccines are simple intramuscular (IM) administration? 5,000. This is a fairly common administration.
...
--vaccines2014.csv
--how many HEPA vaccines did Merck output in 2014 VS. 2015? (part a) Let's compare Merck's growth between two years.
...
--vaccines2016.csv
-- How many state required zoster vaccines did Merck vs Sanofi output in 2016? Sanofi does not produce ZOSTER vaccines.
...
select *
from dataset1.vaccine2016
where UPPER(vax_manu) = 'SANOFI PASTEUR' and UPPER(vax_name) = 'ZOSTER (ZOSTAVAX)'
order by vax_site
