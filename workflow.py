...
sql1 = "create table dataset2.primaryinfo_workflow" +
...
'where vaers_id is not null'
sql2 = 'update dataset2.primaryinfo_workflowp set state = "U" where state is null'
sql3 = 'update dataset2.primaryinfo_workflow set hospitalization = False where hospitalization is null'
sql4 = 'update dataset2.primaryinfo_workflow set disabled = False where disabled is null'
sql5 = 'update dataset2.primaryinfo_workflow set died = False where died is null'
sql6 = 'update dataset2.primaryinfo_workflow set recovered = "U" where recovered is null'
sql7 = 'update dataset2.primaryinfo_workflow set state = UPPER(state) where state != UPPER(state)'
